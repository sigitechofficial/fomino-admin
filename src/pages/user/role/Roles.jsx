...
export default function Roles() {
  ...
  const addRole = async () => {
    if (role === "") {
      info_toaster("Please Enter Role Name");
    } else {
      setLoader(true);
  ...
  const assignPermission = async () => {
    ...
    } else if (permissionData?.permissions === "") {
      info_toaster("Please Select Permission");
    } else {
      setLoader(true);
                ...
                {loader ? (
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      />
                      <RedButton text="Add" onClick={addRole} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      />
                      <RedButton text="Assign" onClick={assignPermission} />
                    </div>
                  </div>
                ) : (
                  <div className="space-y-5">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      />
                      <RedButton text="Assign" onClick={update} />
                    </div>
                  </div>
                )}
              </ModalBody>
