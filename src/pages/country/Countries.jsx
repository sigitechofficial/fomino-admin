...
export default function Countries() {
  ...
  const addNewCountry = async () => {
    if (addCountry?.image === "") {
      info_toaster("Please Add Country Image");
    } else if (addCountry?.name === "") {
      info_toaster("Please Add Country Name");
    } else if (addCountry?.shortName === "") {
      info_toaster("Please Add Country Short Name");
    } else {
      setLoader(true);
              ...
              <div className="flex gap-2 items-center flex-wrap">
                ...
                <div className="flex gap-2">
                  <RedButton
                    ...
                    onClick={() => openModal("Add New Country")}
                  />
                </div>
              </div>
            </div>
                ...
                {loader ? (
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <RedButton text="Add" onClick={addNewCountry} />
                    </div>
                  </div>
                ) : (
                  <div className="space-y-5">
